...
function tweenPropertySuper(target, prop, min, max) {
  ...
  if (prop == "scale") {
    ...
    if (superprop == true  ) randomprop = gsap.utils.random(0.2, 0.4);
    if (superprop == false ) randomprop = gsap.utils.random(0.6, 1.4);
  }

  if (superprop == true ) randomDur = gsap.utils.random(1, 2, 0.2, true);
